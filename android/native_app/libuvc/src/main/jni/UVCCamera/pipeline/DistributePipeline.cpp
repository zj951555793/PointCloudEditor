...
static jint nativeAddPipeline(JNIEnv* env, jobject thiz, ID_TYPE id_pipeline, jobject pipeline_obj) {
...
static jint nativeRemovePipeline(JNIEnv* env, jobject thiz, ID_TYPE id_pipeline, jobject pipeline_obj) {
...
int register_distribute_pipeline(JNIEnv* env) {
    ...
    if (registerNativeMethods(env, "com/serenegiant/usb/DistributePipeline", methods, NUM_ARRAY_ELEMENTS(methods)) <
        0) {
        return -1;
    }
    return 0;
