...
## Android V12 (Android Studio + Qt for Android)

Android arm64-v8a integration is available in `android/README_ANDROID_STUDIO.md`.
The Android target reuses the RK3588 OpenGL ES 3.1 rendering path. Start with
`android/configure_android_studio.bat`, then build the `apk` target and open the generated
`build-android-arm64/android-build` Gradle project in Android Studio.
